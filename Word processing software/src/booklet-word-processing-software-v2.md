...
Build five pages: a cover, an automatic contents page and three short content pages. Use short paragraphs, pictures, lists and a table. You do not need five pages of solid writing!
...
Use guide-word-processing-skills-v2.html from the student resource pack. Its steps match this booklet's task numbers. Your teacher will show you how to open it in a browser.
...
3. Export a PDF in the same folder. Open it and check all pages.
...
Check your actual document. Fix any missing items before ticking them.
...
| Table: Create a table and add a row or column | |
...
| Check: Use editing tools and act on feedback | |
